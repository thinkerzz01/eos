    ...
    return (
      <Shell>
        <div className="bg-white border border-slate-200 rounded-3xl p-10 shadow-sm text-center space-y-3 max-w-lg mx-auto mt-10">
          ...
          <h2 className="font-heading font-medium text-2xl text-slate-900">Link Not Valid</h2>
          <p className="text-sm text-slate-500">{invalid}</p>
          <a href={`https://wa.me/${HELP_WA}`} target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 text-sm font-medium text-emerald-700">
        ...
        <aside className="bg-white border border-slate-200 rounded-3xl p-5 shadow-sm h-fit lg:sticky lg:top-24">
          <div className="flex items-center gap-3 pb-4 border-b border-slate-100">
            ...
            <div>
              ...
              <div className="font-heading font-medium text-lg text-slate-900 leading-tight">{name || 'Student'}!</div>
            </div>
          </div>
