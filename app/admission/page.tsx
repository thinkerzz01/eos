...
// Public DIRECT-ENROLMENT form (no demo, no lead). Same premium multi-step design
// as /onboarding, but it CREATES the student (via submitDirectEnrollment) and lets
// the applicant pick their Program + Exam Session themselves (a demo-origin student
// has those set during booking; a direct enrolee does not). The admin shares
// /admission with a prospective student who enrols after watching a recorded demo.
      ...
      <Shell>
        <div className="bg-white border border-slate-200 rounded-3xl p-10 shadow-lg text-center space-y-4 max-w-xl mx-auto mt-8 animate-in zoom-in-95">
          ...
          <p className="text-sm text-slate-600 max-w-md mx-auto leading-relaxed">
            ...
            Check your email to set your portal password — we'll also reach out on WhatsApp with the next steps.
          </p>
