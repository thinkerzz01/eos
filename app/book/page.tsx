              ...
              <form onSubmit={handleSubmitBooking} className="bg-white border border-slate-200 rounded-3xl p-6 sm:p-8 shadow-sm space-y-7">
                ...
                <div className="pt-6 border-t border-slate-100">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                      <label className={lbl}>Student Email <span className="text-rose-500">*</span></label>
                      <div className="relative"><Mail className="w-4 h-4 text-slate-400 absolute left-3.5 top-1/2 -translate-y-1/2" />
                        <input type="email" required value={parentEmail} onChange={(e) => setParentEmail(e.target.value)} placeholder="e.g. student@gmail.com" className={field} /></div>
                      <p className="text-[11px] text-slate-400 mt-1">The demo class invite and portal login are set up on this email.</p>
                    </div>
                    <div>
