    ...
    <>
      {autoOpen ? null : variant === 'icon' ? (
        ...
        <button
          type="button"
          onClick={() => setOpen(true)}
          className="flex items-center gap-2 w-full text-left px-3 py-2 text-xs font-medium text-slate-700 hover:bg-slate-50 rounded-lg"
        >
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4" onClick={close}>
          ...
          >
            <div className="flex items-start justify-between">
              <div>
                <h3 className="text-base font-medium text-slate-900">Reset password</h3>
            ...
            {!temp ? (
              <div className="mt-4 space-y-2">
                ...
                >
                  ...
                  <span>
                    <span className="block text-sm font-medium text-slate-800">Send reset email</span>
                ...
                >
                  ...
                  <span>
                    <span className="block text-sm font-medium text-slate-800">Generate temporary password</span>
