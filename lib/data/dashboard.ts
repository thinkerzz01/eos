...
const EMPTY: DashboardMetrics = {
  activeTeachers: 0, classesToday: 0, revenueThisMonth: 0, demosNeedingTeacher: 0,
  urgentTickets: 0, collected: 0, outstanding: 0, refunds: 0, feeCollectionPct: 0,
...
export async function getDashboardMetrics(): Promise<DashboardMetrics> {
  ...
  const [teachersRes, classesRes, paymentsRes, vouchersRes, vPaymentsRes, demosRes, ticketsRes, refundsRes, loadRes] =
    await Promise.all([
